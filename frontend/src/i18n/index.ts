...
const resources = {
  en: {
    translation: {
      ...
      hapticAlerts: "Vibration on Alerts",

      // Screen Reader — Accessibility Labels
      "aria.menuBtn": "Open navigation menu",
      "aria.notifBtn": "{{count}} unread notifications",
      "aria.notifBtnNone": "No unread notifications",
      "aria.langBtn": "Change language",
      "aria.accessBtn": "Open accessibility options",
      "aria.backBtn": "Go back",
      "aria.closePanel": "Close panel",
      "aria.darkModeOn": "Dark mode enabled",
      "aria.darkModeOff": "Dark mode disabled",
      "aria.highContrastOn": "High contrast enabled",
      "aria.highContrastOff": "High contrast disabled",
      "aria.hapticOn": "Vibration alerts enabled",
      "aria.hapticOff": "Vibration alerts disabled",
      "aria.reminderLink": "Open reminder settings",
      "aria.fontSlider": "Font size slider",
      "aria.tabHome": "Home",
      "aria.tabSOS": "Emergency contact, SOS button",
      "aria.tabProfile": "My profile",
      "aria.callContact": "Call {{name}}",
      "aria.editContact": "Edit emergency contact",
      "aria.deleteContact": "Delete emergency contact",
      "aria.listenGlucose": "Listen to current glucose value",
      "aria.stopListening": "Stop audio",
      "aria.addReading": "Add glucose reading",
      "aria.prevDay": "Previous day",
      "aria.nextDay": "Next day",
      "aria.selectDate": "Open calendar to select date",
      "aria.glucoseValue": "Current glucose {{value}} milligrams per deciliter, status {{status}}",
      "aria.addTime": "Add reminder time",
      "aria.deleteTime": "Delete reminder at {{time}}",
      "aria.enableReminders": "Toggle custom reminders",

      fontSize: "Font Size",
      fontPreviewText: "Welcome to DiaConnect",
      fontLetter: "A",
      resetDefault: "Reset",
      ...
      reminderMsg: "It's been over 24 hours since your last reading. Log your glucose to improve predictions and stay healthy.",
      ...
      errors: {
        ...
        passwordMin: "Password does not meet requirements",
  ...
  ar: {
    translation: {
      ...
      hapticAlerts: "اهتزاز عند التنبيهات",

      // قارئ الشاشة — تسميات إمكانية الوصول
      "aria.menuBtn": "فتح قائمة التنقل",
      "aria.notifBtn": "{{count}} إشعارات غير مقروءة",
      "aria.notifBtnNone": "لا توجد إشعارات غير مقروءة",
      "aria.langBtn": "تغيير اللغة",
      "aria.accessBtn": "فتح خيارات إمكانية الوصول",
      "aria.backBtn": "العودة",
      "aria.closePanel": "إغلاق اللوحة",
      "aria.darkModeOn": "الوضع الليلي مفعّل",
      "aria.darkModeOff": "الوضع الليلي معطّل",
      "aria.highContrastOn": "التباين العالي مفعّل",
      "aria.highContrastOff": "التباين العالي معطّل",
      "aria.hapticOn": "اهتزاز التنبيهات مفعّل",
      "aria.hapticOff": "اهتزاز التنبيهات معطّل",
      "aria.reminderLink": "فتح إعدادات التذكيرات",
      "aria.fontSlider": "شريط تمرير حجم الخط",
      "aria.tabHome": "الرئيسية",
      "aria.tabSOS": "جهة اتصال الطوارئ، زر SOS",
      "aria.tabProfile": "ملفي الشخصي",
      "aria.callContact": "الاتصال بـ {{name}}",
      "aria.editContact": "تعديل جهة اتصال الطوارئ",
      "aria.deleteContact": "حذف جهة اتصال الطوارئ",
      "aria.listenGlucose": "الاستماع لقيمة السكر الحالية",
      "aria.stopListening": "إيقاف الصوت",
      "aria.addReading": "إضافة قراءة سكر",
      "aria.prevDay": "اليوم السابق",
      "aria.nextDay": "اليوم التالي",
      "aria.selectDate": "فتح التقويم لاختيار تاريخ",
      "aria.glucoseValue": "سكرك الحالي {{value}} ملغ/ديسيلتر، الحالة {{status}}",
      "aria.addTime": "إضافة وقت تذكير",
      "aria.deleteTime": "حذف التذكير عند {{time}}",
      "aria.enableReminders": "تفعيل أو تعطيل التذكيرات المخصصة",

      fontSize: "حجم الخط",
      fontPreviewText: "مرحباً بك في DiaConnect",
      fontLetter: "أ",
      ...
      reminderMsg: "مرّ أكثر من 24 ساعة على آخر قراءة. سجّل قراءتك لتحسين التنبؤ والحفاظ على صحتك.",
      ...
      errors: {
        ...
        passwordMin: "كلمة المرور لا تستوفي المتطلبات",
  ...
  he: {
    translation: {
      ...
      hapticAlerts: "רטט בהתראות",

      // קורא מסך — תוויות נגישות
      "aria.menuBtn": "פתח תפריט ניווט",
      "aria.notifBtn": "{{count}} התראות שלא נקראו",
      "aria.notifBtnNone": "אין התראות שלא נקראו",
      "aria.langBtn": "שנה שפה",
      "aria.accessBtn": "פתח אפשרויות נגישות",
      "aria.backBtn": "חזור",
      "aria.closePanel": "סגור לוח",
      "aria.darkModeOn": "מצב לילה פעיל",
      "aria.darkModeOff": "מצב לילה כבוי",
      "aria.highContrastOn": "ניגודיות גבוהה פעילה",
      "aria.highContrastOff": "ניגודיות גבוהה כבויה",
      "aria.hapticOn": "רטט התראות פעיל",
      "aria.hapticOff": "רטט התראות כבוי",
      "aria.reminderLink": "פתח הגדרות תזכורות",
      "aria.fontSlider": "מחוון גודל גופן",
      "aria.tabHome": "דף הבית",
      "aria.tabSOS": "איש קשר חירום, כפתור SOS",
      "aria.tabProfile": "הפרופיל שלי",
      "aria.callContact": "התקשר אל {{name}}",
      "aria.editContact": "ערוך איש קשר חירום",
      "aria.deleteContact": "מחק איש קשר חירום",
      "aria.listenGlucose": "האזן לערך הסוכר הנוכחי",
      "aria.stopListening": "עצור הקראה",
      "aria.addReading": "הוסף קריאת סוכר",
      "aria.prevDay": "היום הקודם",
      "aria.nextDay": "היום הבא",
      "aria.selectDate": "פתח לוח שנה לבחירת תאריך",
      "aria.glucoseValue": "רמת הסוכר שלך {{value}} מג/דל, מצב {{status}}",
      "aria.addTime": "הוסף זמן תזכורת",
      "aria.deleteTime": "מחק תזכורת ב-{{time}}",
      "aria.enableReminders": "הפעל או כבה תזכורות מותאמות אישית",

      fontSize: "גודל גופן",
      fontPreviewText: "ברוך הבא ל-DiaConnect",
      fontLetter: "א",
      resetDefault: "איפוס",
      ...
      reminderMsg: "עברו יותר מ-24 שעות מאז הקריאה האחרונה. רשום את הקריאה שלך לשיפור התחזיות ולשמירה על בריאותך.",
      ...
      errors: {
        ...
        passwordMin: "הסיסמה אינה עומדת בדרישות",
      ...
      passwordRule: {
        ...
        uppercase: "אות גדולה אחת (A-Z)",
        lowercase: "אות קטנה אחת (a-z)",
        number:    "ספרה אחת (0-9)",
